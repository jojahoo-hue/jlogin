...
Ce workspace est le Jarvis personnel de Njaho. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Njaho et je vis à Fort-de-France, en Martinique. Ingénieur télécom avec 20 ans d'expertise, je suis responsable d'exploitation et des formations dans un opérateur télécom, avec un fort axe sur la digitalisation et l'automatisation. En parallèle, je suis artiste peintre (tradition Congo et géo-mathématique), chercheur sur les civilisations africaines et l'élévation de conscience, entrepreneur digital (sites web, NFT, DCA crypto) et auteur de deux livres.

Mes objectifs prioritaires actuels : automatiser mon centre de supervision, lancer mon univers artistique en ligne, et migrer mes projets de ChatGPT vers Claude en intégrant mes données Notion.

À long terme : transformer mon service en département de résilience réseau de référence, développer une oeuvre artistique et spirituelle reconnue, et écrire pour partager mon cheminement initiatique.

Le domaine où j'ai besoin du plus d'aide en ce moment : apprentissage et formation, notamment lecture efficace et neurosciences appliquées à l'acquisition de connaissances.
